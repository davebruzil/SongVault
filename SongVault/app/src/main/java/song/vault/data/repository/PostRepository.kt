...
class PostRepository(
    ...
    fun observeAllPostsWithUsers(): Flow<List<PostWithUser>> = postDao.observeAllPostsWithUsers()

    fun observePostsByGenre(genre: String): Flow<List<PostWithUser>> = postDao.observePostsByGenre(genre)

    suspend fun getAllPostsWithUsers(): List<PostWithUser> = postDao.getAllPostsWithUsers()

    suspend fun getPostsByGenre(genre: String): List<PostWithUser> = postDao.getPostsByGenre(genre)
    ...
    suspend fun syncAllPosts(): Resource<List<PostEntity>> {
        return try {
